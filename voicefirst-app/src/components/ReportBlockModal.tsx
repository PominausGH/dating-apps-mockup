...
export default function ReportBlockModal({
  ...
  const handleReport = async () => {
    ...
    try {
      ...
      Alert.alert(
        'Report Submitted',
        'Thank you for helping keep our community safe. We will review this report and the associated voice content.',
  ...
  const handleBlock = async () => {
    ...
    try {
      ...
      Alert.alert(
        'User Blocked',
        `${targetUserName || 'This user'} has been blocked. You will no longer see or hear from each other.`,
        [
          {
            text: 'OK',
            onPress: () => {
      ...
      >
        ...
        <View style={styles.menuOptionContent}>
          ...
          <Text style={styles.menuOptionDescription}>
            Report inappropriate voice content or behavior
          </Text>
        </View>
  ...
  const renderReport = () => (
    <ScrollView style={styles.reportContainer}>
      ...
      <TextInput
        ...
        placeholder="Describe the voice content or behavior you're reporting..."
    ...
    <View style={styles.blockContainer}>
      ...
      <View style={styles.blockInfo}>
        ...
        <View style={styles.blockInfoItem}>
          <Ionicons name="checkmark-circle" size={20} color={colors.secondary} />
          <Text style={styles.blockInfoText}>
            Stop all voice messages between you
          </Text>
        </View>
        <View style={styles.blockInfoItem}>
          <Ionicons name="checkmark-circle" size={20} color={colors.secondary} />
          <Text style={styles.blockInfoText}>
            Hide your voice intro from them
          </Text>
        </View>
        <View style={styles.blockInfoItem}>
          <Ionicons name="checkmark-circle" size={20} color={colors.secondary} />
          <Text style={styles.blockInfoText}>
            Hide their voice intro from you
          </Text>
        </View>
      </View>
