...
export default function AccountSettingsScreen() {
  ...
  const handleDeactivateAccount = () => {
    Alert.alert(
      'Pause Account',
      'Your profile and voice intro will be hidden from other users. You can reactivate anytime by logging back in.',
      [
  ...
  const handleDeleteAccount = () => {
    Alert.alert(
      'Delete Account',
      'This will permanently delete your account including your voice intro, all voice messages, matches, and photos. This action cannot be undone.',
      [
        { text: 'Cancel', style: 'cancel' },
        {
          text: 'Delete',
  ...
  const confirmDeleteAccount = () => {
    Alert.alert(
      ...
      'Your account will be permanently deleted. All your voice recordings and data will be removed and cannot be recovered.',
      [
        { text: 'Cancel', style: 'cancel' },
        {
      ...
      <SafeAreaView style={styles.container}>
        <View style={styles.loadingContainer}>
          ...
          <Text style={styles.loadingSubtext}>
            This may take a moment as we remove all your voice recordings and data.
          </Text>
        </View>
      </SafeAreaView>
    );
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <ScrollView style={styles.content}>
        ...
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>Voice Data</Text>

          <TouchableOpacity style={styles.menuItem}>
            <View style={styles.menuItemLeft}>
              <Ionicons name="mic-outline" size={22} color={colors.dark} />
              <Text style={styles.menuItemText}>Manage Voice Intro</Text>
            </View>
            <Ionicons name="chevron-forward" size={20} color={colors.gray[400]} />
          </TouchableOpacity>

          <Text style={styles.infoNote}>
            Your voice intro is how potential matches hear you. You can re-record
            it anytime from your profile.
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.dangerNote}>
            ...
            your voice intro, voice messages, matches, and photos. This action
            cannot be undone.
          </Text>
        </View>
