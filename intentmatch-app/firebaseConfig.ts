...
const firebaseConfig = {
  ...
  authDomain: process.env.EXPO_PUBLIC_FIREBASE_AUTH_DOMAIN || 'intentmatch.firebaseapp.com',
  projectId: process.env.EXPO_PUBLIC_FIREBASE_PROJECT_ID || 'intentmatch',
  storageBucket: process.env.EXPO_PUBLIC_FIREBASE_STORAGE_BUCKET || 'intentmatch.appspot.com',
 ...
 *    - Click "Add project"
 *    - Name it "IntentMatch" or your preferred name
 *    - Enable Google Analytics (optional)
 *
 * 2. Register your app:
 *    - In Firebase Console, click the web icon (</>)
 *    - Register app with nickname "IntentMatch Web"
